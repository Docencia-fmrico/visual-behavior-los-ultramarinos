...
public:
  ImageConverter(): it_(nh_)
  {
    ...
    cv::setTrackbarPos("Hue Upper", "Imagen filtrada", 146);
    cv::setTrackbarPos("Hue Lower", "Imagen filtrada", 136);
    cv::setTrackbarPos("Sat Upper", "Imagen filtrada", 255);
    cv::setTrackbarPos("Sat Lower", "Imagen filtrada", 128);
    cv::setTrackbarPos("Val Upper", "Imagen filtrada", 255);
    cv::setTrackbarPos("Val Lower", "Imagen filtrada", 119);
  ...
  {
    hsvinfo->hsv[IDX_h] = 136;
    hsvinfo->hsv[IDX_H] = 146;
    hsvinfo->hsv[IDX_s] = 128;
    hsvinfo->hsv[IDX_S] = 255;
    hsvinfo->hsv[IDX_v] = 119;
  ...
  void imageCb(const sensor_msgs::Image::ConstPtr& msg)
  {
    ...
    //// lo miramos mañana
    ////cv::Mat borrosa ;
    ////cv::blur(cv_ptr->image,borrosa,cv::Size(3,3));

    ////cv::Mat hsv;
    ////cv::cvtColor(borrosa, hsv, CV_RGB2HSV); //cambio
